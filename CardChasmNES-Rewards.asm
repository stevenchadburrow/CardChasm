...
; reward sub-routines for Card Chasm NES
...
@select2
	...
	STA title_position
	STA title_timer
	STA reward_position+0
	STA reward_position+1
...
reward_arrow_data
	...
	.BYTE $80,$00,$00,$FF,$FF,$00,$00,$80,$00,$00,$00,$FF,$FF,$00,$00,$00
	.BYTE $00,$00,$00,$FF,$FF,$00,$00,$00,$00,$00,$03,$FF,$FF,$03,$00,$00
	.BYTE $00,$F0,$00,$FF,$FF,$00,$F0,$00,$00,$00,$FC,$FF,$FF,$FC,$00,$00
...
@button2
	...
	AND #$08 ; up
	BEQ @button3
	LDA reward_position,X
	BEQ @button3
	SEC
	SBC #$01
	STA reward_position,X
	LDA #$01
	STA buttons_wait
	LDA #$F8 ; shift amount
	STA card_shift_timer
...
@button6
	...
	LDX reward_position+0
	LDY reward_position+1
	LDA card_side_number,Y
	BEQ @button7
	LDA card_side_movement,Y
	BEQ @button7

	; swap between deck and sideboard
